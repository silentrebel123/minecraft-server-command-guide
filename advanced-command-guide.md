...
`/jobs info <job name> 2` - Displays informations about the given job from page 2.
`/jobs info <job name> place` - Displays informations about the given job with the specified action type.
